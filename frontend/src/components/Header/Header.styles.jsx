...
import UnstyledMobileLogo from "assets/logo-mobile.svg";
...
export const LogoLink = styled(UnstyledLink)`
  ...
  line-height: 0;
`;
export const Logo = styled.div` //(UnstyledDesktopLogo)
...
export const MobileLogo = styled.img` //(UnstyledMobileLogo)
background: url('/images/logo_web.png');
  @media ${QUERIES.laptopAndUp} {
    display: none;
  }
